...
const Impact= (params: Props) => {
    ...
    return <div {...storyblokEditable(params.blok)} ref={ref} className={`
     my-36 max-w-6xl xl:mx-auto mx-4 flex md:justify-between md:items-center xl:flex-row flex-col-reverse gap-12 xl:gap-0  transition-all duration-700 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
