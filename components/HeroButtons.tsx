    ...
    return (
        <section {...storyblokEditable(params.blok)} className="mb-36  mt-12 max-w-6xl xl:mx-auto mx-4 flex xl:justify-between xl:items-center">
            <div className="xl:max-w-[32rem] w-full">
                <h1 className="font-bold text-4xl mb-4 text-center xl:text-left" dangerouslySetInnerHTML={{ __html: handleRichText(params.blok.Heading)?.__html ?? "" }} />
                <p className="text-base text-center xl:text-left">{params.blok.Content}</p>
                <div className="flex mt-8 items-center justify-center xl:justify-start gap-8">
